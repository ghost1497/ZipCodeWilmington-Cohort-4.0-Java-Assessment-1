...
public class StringUtils {
    ...
    public static String getFirstWord(String sentence) {
        String[] strArray = getWords(sentence);
        return strArray[0];
    }
    ...
    public static String reverseFirstWord(String sentence) {
        String[] strArray = getWords(sentence);
        String reversedFirstWord = BasicStringUtils.reverse(strArray[0]);
    ...
    public static String reverseFirstWordThenCamelCase(String sentence) {
        String[] strArray = getWords(sentence);
        String reversedFirstWordAndThen = BasicStringUtils.reverseThenCamelCase(strArray[0]);
        return reversedFirstWordAndThen;
    }
