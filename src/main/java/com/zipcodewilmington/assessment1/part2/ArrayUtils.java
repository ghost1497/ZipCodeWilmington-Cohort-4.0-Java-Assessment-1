...
public class ArrayUtils {
    ...
    public static Integer[] removeValue(Integer[] objectArray, Integer objectToRemove) {
        ...
        objectArray = buffer.toArray(new Integer[buffer.size()]);
        return objectArray;
    }
    ...
    public static Integer[] mergeArrays(Integer[] objectArray, Integer[] objectArrayToAdd) {
        ...
        for(int i = 0; i < objectArray.length; i++){
            mergedArray[indexCounterForNewArray] = objectArray[i];
            indexCounterForNewArray++;
        }
        for(int i = 0; i < objectArrayToAdd.length; i++){
            mergedArray[indexCounterForNewArray] = objectArrayToAdd[i];
            indexCounterForNewArray++;
        }
        return mergedArray;
    }
